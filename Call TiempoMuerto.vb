      ...
      'If Now >= CDate(CDate((CDbl(CDate(UltimoConteo)) + AlertaSupervisor))) Then '  0.003  = 5 minutos
          Dim FechaCompara As Date
                 If CDbl(Time) > 0 And CDbl(Time) < 0.302083 Then    'Es tercer turno
                         FechaCompara = CNN.rsCmdUltimoConteoxJC!FechaCap + 1
                  Else
                        FechaCompara = CNN.rsCmdUltimoConteoxJC!FechaCap
                 End If
                
            UltimoConteo = CDate(FechaCompara & " " & CNN.rsCmdUltimoConteoxJC!HoraFin)
            ...
            LastConteo = (CDate(UltimoConteo)) + AlertaSupervisor
                    ...
                    Me.LblNow.Caption = Now_

        If Now_ > LastConteo Then
            
            'Sí, hay tiempo muerto
            
            Me.Shstatus.BackColor = vbRed

            Me.lbldelay.Caption = Format(Now_ - CDate((CDbl(CDate(UltimoConteo)))), "hh:mm:ss")
