...
colorBlanco1 = np.array([213, 212, 203], np.uint8)
colorBlanco2 = np.array([210, 217, 209], np.uint8)

# Leer la imagen
image = cv2.imread('images/vidrio1.png')
#image = cv2.imread('images/vidrio1.png')
...
maskBlanco1 = cv2.inRange(imageHSV, colorBlanco1, colorBlanco2)
#mask = cv2.add(maskRojo1,maskRojo2)
mask = cv2.add(maskBlanco1,maskBlanco1)
